...
public class User extends BaseEntity
{
    ...
    @Excel(name = "岗位职级", readConverterExp = "0=男,1=女,2=未知")
    ...
    /** 帐号状态（0正常 1停用） */
    @Excel(name = "用户类型", readConverterExp = "0=考官,1=考员")
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("dept", getDept())
            .append("ischecker", getIschecker())
            .toString();
    }

	public Long[] getDepts() {
		return depts;
	}

	public void setDepts(Long[] depts) {
		this.depts = depts;
	}
}
